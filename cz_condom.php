<div id="sekciaKondomy" class="row nazovSekcie"><h2>Kondómy</h2></div>

<?php

	function vypisVysledokKondom($result, $type_name) {
        echo "<div class='row'>";
    ...
    $my_query_0 = "SELECT t.name as type_name from category as c inner join type as t on c.id_category = t.id_category where c.name = 'condom'";
    ...
    while ($row = mysqli_fetch_array($result_0)) {
        ...
        vypisVysledokKondom($result, $row['type_name']);
    }
